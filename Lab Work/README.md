...
- `Lab5_FrequentlyUsedMethods/` – Built-in Python methods for data handling (enumerate, zip, map, filter, sorted, reversed, range, any, all, type, len, sum, min, max, abs, round, divmod, pow)  
- `Lab6_ListAndTuple/` – Working with lists and tuples, indexing, slicing, mutator methods, comprehensions, packing/unpacking, and conversions  
- `Lab7_Dictionary/` – Dictionaries, nested dictionaries, accessing, updating, deleting entries, and using built-in methods  
- `Lab8_LambdaFunctions/` – Lambda functions, anonymous functions, map/filter/reduce, and using lambda for sorting and conditional operations  
...
This collection serves as a comprehensive reference for fundamental Python skills in AI programming and related engineering tasks.
